// RSPO — Indonesia 2,026 + 글로벌 9,343
...
export function renderRspo(root) {
  ...
  root.innerHTML = `
    ...
    <div class="kpis">
      ${kpiHTML("Indonesia RSPO 회원", fmtInt(idMembers.length), `Active ${active}`, "blue")}
    ...
    <div class="grid-2">
      <div class="card"><h3>카테고리별</h3><div id="rspo-cat-pie" class="plot"></div></div>
      <div class="card"><h3>인증기관 (Certification Body) Top 10</h3><div id="rspo-cb" class="plot"></div></div>
    </div>

    <div class="grid-2">
      <div class="card"><h3>국가별 Top 15 (글로벌)</h3><div id="rspo-country-bar" class="plot"></div></div>
      <div class="card"><h3>PC 면적 국가별 Top 15</h3><div id="rspo-pc-area" class="plot"></div></div>
    </div>
